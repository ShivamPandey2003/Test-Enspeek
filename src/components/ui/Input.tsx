  ...
  "flex w-full border disabled:cursor-not-allowed disabled:opacity-50 file:border-0 file:text-sm file:font-medium focus-visible:outline-none",
  {
    variants: {
      variant: {
        ...
        questionnaire:
          "questionnaire-heading min-h-9 rounded-xl border border-[var(--color-login-primary)]/35 bg-white px-1.5 py-0 text-[15px] text-[var(--color-login-input-text)] placeholder:text-[var(--color-text-muted)] focus-visible:border-[var(--color-login-primary)]/35 focus-visible:ring-0",
        crosstab:
